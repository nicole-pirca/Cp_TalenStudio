...
package cp_talenstudio.job1_0_1;
...
/**
 * Job: Job1 Purpose: Visualizar la interaccion de ramas del Job1<br>
 * Description: <br>
 * 
 * @author Pirca, Nicole
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row1.score_riesgo = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Job1.class.getClassLoader()
					.getResourceAsStream("cp_talenstudio/job1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
